  ...
  return (
    <div className="min-h-screen" style={{ paddingTop: "7rem" }}>
              ...
              >
                <div className="h-48 bg-white flex items-center justify-center">
                  <img
                    src={client.logo}
                    alt={client.name}
                    className="w-full h-full object-contain" style={{padding: '8px 30px'}}
                  />
                </div>
      ...
      >
        ...
        >
          <div className="text-center" style={{ marginBottom: "64px" }}>
            <h2 className="text-4xl font-bold" style={{ marginBottom: "16px" }}>
            ...
            <p
              ...
              style={{ marginLeft: "auto", marginRight: "auto" }}
            >
              Our commitment to excellence and long-term partnerships sets us
              apart.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-300">
                25+ years of successful project delivery with zero safety
                incidents.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-300">
                Building lasting relationships with clients through consistent
                quality service.
              </p>
            </div>
            <div className="text-center">
      ...
      >
        ...
        >
          ...
          >
            Experience the Samarth Enterprise difference. Contact us today to discuss your
