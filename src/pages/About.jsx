          ...
          <ScrollReveal>
            ...
            >
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-300">
                ...
                construction and industrial projects with unwavering commitment
              ...
              <AnimatedSection direction="left">
                <div>
                  ...
                  >
                    ...
                    reliable heavy lifting solutions to the construction
                    industry. What started with just three mobile cranes has
                    grown into one of the region's most trusted crane hire
                    specialists.
                  </p>
                  <p
                    className="text-lg text-slate-600"
                  ...
                  <p className="text-lg text-slate-600">
                    ...
                    while maintaining the highest safety standards. Every
                    project, regardless of size, receives our full attention and
                    expertise.
                  </p>
                </div>
              </AnimatedSection>
          ...
          >
            <div className="text-center" style={{ marginBottom: "64px" }}>
              ...
              <ScrollReveal delay={200}>
                ...
                >
                  From humble beginnings to industry leadership, here are the
                  key milestones that have shaped Samarth Enterprise into the
            ...
            <div className="relative">
              <ScrollReveal>
                <div className="absolute md:z-2 left-1/2 transform -translate-x-1/2 h-full w-1 bg-orange-500" />
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                <ScrollReveal delay={value.delay} key={index}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <AnimatedSection direction="left">
                <div>
                  ...
                  >
                    We offer comprehensive lifting solutions with
                    state-of-the-art equipment and unmatched expertise across
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  >
                    ...
                    excellence is demonstrated through our comprehensive safety
          ...
          >
            <div className="text-center" style={{ marginBottom: "64px" }}>
              ...
              <ScrollReveal delay={200}>
                ...
                >
                  ...
                  with vision, expertise, and unwavering commitment to
                  excellence.
                </p>
              </ScrollReveal>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {teamMembers.map((member, index) => (
                <ScrollReveal delay={member.delay} key={index}>
                  <div
                    key={index}
